package com.chemista.dev.DiCh.security;

import com.chemista.dev.DiCh.domain.PersistentToken;
import com.chemista.dev.DiCh.repository.PersistentTokenRepository;
...
import com.chemista.dev.DiCh.framework.security.PersistentTokenCache;
import com.chemista.dev.DiCh.framework.security.RandomUtil;
...
public class PersistentTokenRememberMeServices extends
    ...
    public PersistentTokenRememberMeServices(ServletTunerProperties servletTunerProperties,
                                             org.springframework.security.core.userdetails.UserDetailsService userDetailsService,
                                             PersistentTokenRepository persistentTokenRepository, UserRepository userRepository) {

        super(servletTunerProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
