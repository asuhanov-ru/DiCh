...
public class MailService {
    ...
    public MailService(ServletTunerProperties servletTunerProperties, JavaMailSender javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom(servletTunerProperties.getMail().getFrom());
    ...
    public void sendEmailFromTemplate(User user, String templateName, String titleKey) {
        ...
        context.setVariable(BASE_URL, servletTunerProperties.getMail().getBaseUrl());
