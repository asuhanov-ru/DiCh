...
import com.chemista.dev.DiCh.framework.config.liquibase.SpringLiquibaseUtil;
...
public class LiquibaseConfiguration {
    ...
    public SpringLiquibase liquibase(@Qualifier("taskExecutor") Executor executor,
        ...
        if (env.acceptsProfiles(Profiles.of(ServletTunerConstants.SPRING_PROFILE_NO_LIQUIBASE))) {
