...
public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    public MetricsConfiguration(ServletTunerProperties servletTunerProperties) {
    ...
    public void init() {
        ...
        if (servletTunerProperties.getMetrics().getJmx().isEnabled()) {
        ...
        if (servletTunerProperties.getMetrics().getLogs().isEnabled()) {
            ...
            final Slf4jReporter reporter = Slf4jReporter.forRegistry(metricRegistry)
                    ...
                    .build();
            reporter.start(servletTunerProperties.getMetrics().getLogs().getReportFrequency(), TimeUnit.SECONDS);
        }
    }
}
