package com.chemista.dev.DiCh.framework.config.logging;
...
public final class LoggingUtils {
    ...
    public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields,
                                                    ServletTunerProperties.Logging.Logstash logstashProperties) {
     ...
     */
    public static void addContextListener(LoggerContext context, String customFields, ServletTunerProperties.Logging properties) {
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        private final ServletTunerProperties.Logging loggingProperties;
        private final String customFields;

        private LogbackLoggerContextListener(ServletTunerProperties.Logging loggingProperties, String customFields) {
