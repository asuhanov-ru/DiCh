...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEXTBLOCK_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEXTBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEXTBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEXTBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEXTBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEXTBLOCK actions', async () => {
      const expectedActions = [
        {
