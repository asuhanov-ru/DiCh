...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLECTIONS actions', async () => {
      const expectedActions = [
        {
