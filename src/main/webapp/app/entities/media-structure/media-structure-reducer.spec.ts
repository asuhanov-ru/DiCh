...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDIASTRUCTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEDIASTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEDIASTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEDIASTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEDIASTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEDIASTRUCTURE actions', async () => {
      const expectedActions = [
        {
