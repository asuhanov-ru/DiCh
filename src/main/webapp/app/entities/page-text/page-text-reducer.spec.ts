...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './page-text.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGETEXT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAGETEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGETEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGETEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGETEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGETEXT actions', async () => {
      const expectedActions = [
        {
