  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="diChApp.author.home.createOrEditLabel" data-cy="AuthorCreateUpdateHeading">
            <Translate contentKey="diChApp.author.home.createOrEditLabel">Create or edit a Author</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('diChApp.author.name')} id="author-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('diChApp.author.callsign')}
                id="author-callsign"
                name="callsign"
                data-cy="callsign"
                type="text"
              />
              <ValidatedField
                label={translate('diChApp.author.description')}
              ...
              />
              <ValidatedBlobField
                label={translate('diChApp.author.image')}
                id="author-image"
                name="image"
                data-cy="image"
                isImage
