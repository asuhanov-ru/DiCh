...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ocr-tasks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OCRTASKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_OCRTASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OCRTASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OCRTASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OCRTASKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OCRTASKS actions', async () => {
      const expectedActions = [
        {
