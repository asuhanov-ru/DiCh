...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './page-word.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGEWORD_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAGEWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGEWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGEWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGEWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGEWORD actions', async () => {
      const expectedActions = [
        {
