...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGEIMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAGEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGEIMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGEIMAGE actions', async () => {
      const expectedActions = [
        {
