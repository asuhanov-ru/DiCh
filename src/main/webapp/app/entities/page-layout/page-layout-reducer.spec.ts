...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGELAYOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAGELAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGELAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGELAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGELAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGELAYOUT actions', async () => {
      const expectedActions = [
        {
