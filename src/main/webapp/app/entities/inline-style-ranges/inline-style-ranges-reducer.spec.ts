...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inline-style-ranges.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INLINESTYLERANGES_LIST actions', async () => {
    ...
    it('dispatches FETCH_INLINESTYLERANGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INLINESTYLERANGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INLINESTYLERANGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INLINESTYLERANGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INLINESTYLERANGES actions', async () => {
      const expectedActions = [
        {
